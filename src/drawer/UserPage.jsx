...
const UserPage = ({ isOpen, setOpen }) => {
 ...
 const handlelogout = () => {
  ...
  return (
    <div
      className={` ${isOpen ? "translate-x-0" : "-translate-x-64"} fixed inset-0 z-50 flex justify-end  transition-transform duration-300 ease-in-out`}
    >
      {/* Overlay */}
      ...
      <div className=" relative w-72 bg-[#0d3b66] text-white shadow-lg flex flex-col items-center py-6 rounded-l-lg">
        ...
        <div className="text-center">
          <h3 className="font-semibold text-lg">Mr. Admin</h3>
          <p className="text-sm text-gray-200">from Itsybizz</p>
        </div>
        ...
        <nav className="mt-8 w-full px-6">
          ...
          <ul className="flex flex-col gap-3 text-sm font-medium">
            ...
            <li>
              <button
                className="flex items-center gap-3 text-red-200 w-full p-2 rounded hover:bg-sky-900 transition"

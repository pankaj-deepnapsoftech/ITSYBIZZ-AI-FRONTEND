...
const Header = () => {
  ...
  const developmentmenu = [
    ...
    { title: "CRM Development", link: "/crm" },
  ];

  const becomeBrand = [
    { title: "Brand Building", link: "/brand-building" },
    { title: "ORM", link: "/brand-orm" },
  ...
  const products = [
    ...
    },
    {
      ...
      link: "/Factory-Automation-Software",
    },
    {
      title: "Factory Automation Hardware",
      link: "/Factory-Automation-Hardware",
    },
    {
      title: "Industrial Automation Software",
      link: "/Industrial-Automation-Software",
    },
    {
      title: "Industrial IoT Hardware",
      link: "/Industrial-IoT-Hardware",
    },
    {
      title: (

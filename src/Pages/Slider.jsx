...
const TabBar = () => {
  ...
  const CircleDot = ({ service, isActive }) => {
    ...
    return (
      <motion.div
        ...
        ${isActive ? "glow-effect scale-110" : "hover-glow"}
      `}
  ...
  return (
    <div
      className="w-full relative overflow-hidden min-h-[40vh]
 max-w-[2480px] mx-auto layout-stable"
    >
      {/* Floating Elements */}
      <div
      ...
      <div className="pt-5  2xl:pt-8 relative z-10 responsive-padding">
        ...
        <motion.div
          className="pt-10 flex flex-col md:flex-row justify-center items-center space-y-6 md:space-y-0 md:space-x-8 lg:space-x-12 px-4 md:px-8 lg:px-12"
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}

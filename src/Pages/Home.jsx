...
const Home = () => {
  ...
  return (
    <div className="w-full relative overflow-hidden">
      {/* Hero Section */}
      <div
        className="relative bg-gradient-to-br from-[#053d5e] via-[#0a5a7a] to-[#0d6b8a] 
...
py-12 sm:py-16 md:py-20 lg:py-24 xl:py-32 2xl:py-40 overflow-hidden"
        ...
        <div className="relative z-10 grid gap-6 sm:gap-8 md:gap-10 lg:gap-12 md:grid-cols-2 pb-12 sm:pb-16 md:pb-20">
          ...
          >
            <p className="text-gray-200 text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed mobile-hero-description tablet-hero-description laptop-hero-description">
              ITSYBIZZ is a leading digital solutions company offering a wide
              range of services including Software Development, Mobile App
              Development, Website Development, AI, Blockchain Development, Game
              Development, and IoT Solutions. We also specialize in Brand
              Building and delivering Ready-to-Use Software like CRM, HRM, and
              Production Automation Suites (B2B & B2C).
            </p>
      ...
      {/* Tech Stack Section */}
      <div className="w-full py-12 sm:py-16 md:py-20 bg-gradient-to-br from-[#2e2f86] to-[#00507a] flex flex-col items-center justify-center gap-6 sm:gap-8 px-4 sm:px-6 md:px-8 relative overflow-hidden">

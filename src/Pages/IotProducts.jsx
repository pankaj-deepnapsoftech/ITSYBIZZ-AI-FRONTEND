...
import { FaDownload, FaServer, FaClock } from "react-icons/fa";
  ...
  const features = [
    {
      ...
      text: "Kontrolix continuously captures live machine data such as production count, RPM, temperature, pressure, and operational status — delivering zero-delay shop-floor visibility.",
    },
    {
      icon: <FaServer size={26} />,
      title: "Socket-Based Live Data Streaming",
      text: "High-performance socket architecture ensures real-time data flow without polling delays, ideal for high-speed industrial environments.",
    },
    {
      icon: <FaDownload size={26} />,
      title: "Advanced Reports & Excel Exports",
      text: "Download detailed production reports, stoppage logs, shift analytics, and historical data in Excel & CSV formats.",
    },
    {
      icon: <FaClock size={26} />,
      title: "Downtime & Stoppage Analytics",
      text: "Automatically track downtime, breakdowns, idle time, and restart events with precise timestamps.",
    },
  ];

  const stats = [
    { number: "100%", label: "Live Data Accuracy" },
    { number: "24×7", label: "Real-Time Monitoring" },
    { number: "Milliseconds", label: "Socket Latency" },
    { number: "Excel & CSV", label: "Export Ready" },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      <div className="max-w-7xl mx-auto px-6 py-20">
        ...
        >
          <span className="inline-block px-6 py-2 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-sm font-semibold mb-6">
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            <strong>Kontrolix</strong> is a next-generation Industrial IoT
            platform providing complete real-time visibility of machines and
            production. From live status to advanced analytics, it empowers
            manufacturers to make smarter, faster decisions.
          </p>
        </motion.div>

        {/* STATS */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto mb-28 reveal">
        ...
        {/* FEATURES */}
        <div className="grid md:grid-cols-2 gap-10 max-w-6xl mx-auto mb-32 reveal">
        ...
        <motion.div className="text-center reveal">
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-3xl shadow-2xl p-14">
            <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-6">
              Take Control of Your Manufacturing Operations
            </h2>
            <p className="text-blue-100 text-lg mb-10 max-w-2xl mx-auto">
              Transform raw machine data into actionable insights, reduce
              downtime, and build a truly data-driven factory with Kontrolix.
            </p>
            <button className="bg-white text-blue-600 px-12 py-4 rounded-full font-bold text-lg hover:bg-gray-100 transition hover:scale-105 shadow-lg" onClick={()=>navigate("/contact-us")}>
              Request a Live Demo
            </button>
          </div>
        </motion.div>
